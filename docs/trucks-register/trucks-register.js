...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.getElementById('googleBtn').addEventListener('click', async () => {
        try {
            ...
            const redirectUrl = `${window.location.origin}${basePath}/docs/trucks-register/complete-profile.html`;
        ...
        try {
            ...
            card.innerHTML =
                '<div style="text-align: center; padding: 2rem;">' +
                    '<h2><i class="fas fa-check-circle" style="color: var(--success);"></i> Almost there!</h2>' +
                    '<p style="margin-top: 1rem; font-size: 1.1rem;">We\'ve sent a verification link to <strong>' + email + '</strong>.</p>' +
                    '<p style="margin-top: 0.5rem;">Please check your inbox and click the link to activate your account.</p>' +
                    '<a href="../trucks-login/trucks-login.html" class="btn-submit" style="margin-top: 2rem; text-decoration: none;">Proceed to Login</a>' +
                '</div>';
